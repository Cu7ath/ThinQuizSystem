...
<%
    ...
    if (quizIdStr == null) {
        out.println("<script>alert('Quiz ID not provided.'); window.location='"+ request.getContextPath() +"/listQuiz.jsp';</script>");
        return;
    }
    ...
    try {
        ...
        conn.close();
        out.println("<script>alert('Quiz deleted successfully.'); window.location='"+ request.getContextPath() +"/listQuiz.jsp';</script>");
    } catch (Exception e) {
        out.println("<script>alert('Error: " + e.getMessage() + "'); window.location='"+ request.getContextPath() +"/listQuiz.jsp';</script>");
    }
%>
