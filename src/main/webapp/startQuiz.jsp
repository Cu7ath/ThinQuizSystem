...
<%
    ...
    if (currentIndex >= questions.size()) {
        response.sendRedirect(request.getContextPath()+"submitQuiz.jsp?quizId=" + quizId);
        return;
    }
...
<h3 id="timer"></h3>
<form id="quizForm" action="${pageContext.request.contextPath}/startQuiz.jsp" method="post">
