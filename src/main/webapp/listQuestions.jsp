...
<html>
    ...
    <body>
        ...
        <a class="btn" href="addQuestion.jsp">+ Add New Question</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="btn-group">
                    <a class="btn" href="editQuestion.jsp?id=<%= rs.getInt("id")%>">Edit</a>
                    <a class="btn" href="deleteQuestion.jsp?id=<%= rs.getInt("id")%>" onclick="return confirm('Are you sure want to delete the Question?')">Delete</a>
                </td>
        ...
        <br>
        <a class="btn" href="teacherHome.jsp">Back to Home</a>
