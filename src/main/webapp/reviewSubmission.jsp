...
<body>
    <div class="container">
        ...
        <% if ("student".equals(role)) { %>
            <a href="${pageContext.request.contextPath}/StudentSubmissionHistory.jsp">?? Back to History</a>
        <% } else if ("teacher".equals(role)) { %>
            <a href="${pageContext.request.contextPath}/ViewSubmission.jsp">?? Back to Submissions</a>
        <% } %>
    </div>
</body>
</html>
