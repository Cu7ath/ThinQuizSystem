...
public class SubmitFeedbackServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!rs.next()) {
                out.println("<script>alert('Pelajar tidak ditemui.'); window.location='"+ request.getContextPath() +"/studentHome.jsp';</script>");
                return;
            }
            ...
            conn.close();
            out.println("<script>alert('Terima kasih atas maklum balas anda!'); window.location='"+ request.getContextPath() +"/studentHome.jsp';</script>");
        } catch (Exception e) {
